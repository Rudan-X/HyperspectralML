...
ggplot(dfr2[dfr2$data_split=="Calibration",], aes(x=trait, y=score,fill=datatype)) +
  geom_boxplot()+
...
ggsave("Figures/SF_sec3.2_PLSR_SVR_data_aggregation_calibration.png",width = 10, height = 7)
