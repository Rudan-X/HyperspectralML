...
ggplot(dftot, aes(x=Year, y=Correlation,fill=Type)) +
  geom_boxplot() + 
  stat_compare_means(label = "p.signif",label.y.npc = "top")+
  scale_fill_brewer(palette = "Dark2")+
  theme(legend.position = "bottom",legend.text = element_text(size=16,face="plain"),legend.title=element_text(size=17,face="bold"),
...
ggsave("figures/SF6_randomization3years.png",width = 13, height = 8)
