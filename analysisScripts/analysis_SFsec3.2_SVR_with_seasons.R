...
vars<-c("SLA","Vmax","a400","phiPSII_ind_res","maxNPQ") #"SLA","N","Vmax","a400","phiPSII_ind_res","maxNPQ"

for (datatype in c("raw_data")){ # c(),"plot_averaged","genotype_averaged"
  for (inVar in vars){
    ...
    load(paste0("results/compare_season/PLSR_repeatedCV_model_",datatype,"_",agg,year,"_o", segments0*nrep,"i",segment*repl,"_",inVar,".RData"))
    ...
    save(res.rcv.svr,file= paste0("results/compare_season/SVR_model_",datatype,"_",agg,year,"_o", segments0*nrep,"_",inVar,".RData"))
  }
}
