...
for (inVar in vars){
  ...
  for (d in 1:endd){
    ...
    res.rcv.mse <- list(R2 = templ,r2 = templ, RMSEP = templ, RMSEPper = templ, bestnoc = temp, pred = temp2)
    res.singlecv.mse <- list(R2 = templ,r2 = templ, RMSEP = templ, RMSEPper = templ, bestnoc = temp, pred = temp2)
    ...
    save(res.rcv.mse,res.singlecv.mse, file=paste0("results/comparePLSR_SVR/PLSR_repeatedCV_model_",datatype,"_",agg,year,"_o", segments0*nrep,"i",segment*repl,"_",inVar,".RData"))
  }
}
