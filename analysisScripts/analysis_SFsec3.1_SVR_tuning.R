...
for (datatype in c("plot_averaged","genotype_averaged")){ # c()"raw_data"
  for (inVar in vars){
    ...
    save(res.rcv.svr,file= paste0("results/comparePLSR_SVR/tuned_SVR_model_",datatype,"_",agg,year,"_o", segments0*nrep,"_",inVar,".RData"))
  }
}
