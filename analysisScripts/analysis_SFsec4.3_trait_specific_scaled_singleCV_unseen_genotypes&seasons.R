...
for (y in 1:6){
  for (i in 1:1){ #length(vars)
    ...
    if (MLs[i]=="PLSR"){
      ...
      filen <- paste0("results/unseen_seasons_and_genotypes_specific/PLSR_model_scaled_",datatype,"_",agg,"_training",year_train[y],"_testing",year_test[y],"_o", segments0*nrep,"_i",segment*repl,"_",inVar,".RData")
      ...
      filen <- paste0("results/unseen_seasons_and_genotypes_specific/SVR_model_scaled_",datatype,"_",agg,"_training",year_train[y],"_testing",year_test[y],"_o", segments0*nrep,"_i",segment*repl,"_",inVar,".RData")
